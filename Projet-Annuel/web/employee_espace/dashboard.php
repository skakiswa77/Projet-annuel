...
if (!isset($_SESSION['user_id']) || $_SESSION['user_role'] !== 'employee') { // Remplacer ROLE_ICI par 'company_admin', 'employee' ou 'provider'
...
$spaceName = "Espace Employé"; // À remplacer par "Espace Entreprise", "Espace Employé" ou "Espace Prestataire"
?>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <!-- Menu pour l'espace Employé (à afficher seulement si l'utilisateur est employee) -->
